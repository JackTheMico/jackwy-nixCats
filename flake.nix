...
{
  description =
    "Jack Wenyoung Lua-natic's neovim flake, with extra cats! nixCats!";
      ...
      categoryDefinitions = { pkgs, settings, categories, extra, name
        , mkNvimPlugin, ... }@packageDef: {
          ...
          lspsAndRuntimeDeps = with pkgs; {
            ...
            nix = [ nix-doc nil nixd nixfmt-rfc-style ];
            neonixdev =
              [ nix-doc nil lua-language-server nixd nixfmt-rfc-style ];
            astro = [
          ...
          optionalPlugins = with pkgs.vimPlugins; {
            ...
            other = [ todo-comments-nvim which-key-nvim ];
            treesitter = [
              nvim-treesitter-textobjects
              nvim-treesitter-context
              (nvim-treesitter.withPlugins
                (plugins: with plugins; [ nix lua python yaml toml json ]))
            ];
            debug = {
          ...
          extraPython3Packages = { python = (py: [ py.debugpy py.pytest ]); };
